...
- 코드작성부분에서 ;이 나왔을 때 실행되지 않도록 ;을 무시하게 하기 위해서 사용 */ 
use portal;
/* 학생이 강의를 수강신청하면 해당 강의의 현재 정원이 1 증가하는 트리거 */
...
use example;
/* 주문 테이블에 주문내역이 추가되면 제품 테이블의 재고량이 변하는 트리거 
*/
...
begin
	...
	*/
    /* 
    - 변수선언(begin 바로 밑에 변수들을 모아서 선언해야 함) 
