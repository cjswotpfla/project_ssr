...
public class ValuableEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * */
		//i는 11번째 줄부터 21번째 줄까지 사용가능, 
		int i;//i는 main메소드 안에서 선언했기 때문에 선언 위치부터 main메소드 끝까지 사용 가능
		for(i=1;i<=5;i+=1) {
			System.out.print("*");
		}
		System.out.println(i);
		//k는 17번쨰 줄부터 18번째 줄까지 사용 가능
		for(int k=1; k<=5 ; k+=1) {//k는 반복문에서만 선언했기 때문에 반복문에서만 사용 가능
			System.out.print("*");
		}
		System.out.println();
